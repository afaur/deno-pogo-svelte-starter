...
import { fly, slide, scaleOutVertical } from "/js/libTransitions.mjs";
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$set = ($$props) => {
    if ("transition" in $$props) {
      $$invalidate(2, transition = $$props.transition);
    }
  };

  return [items, intro, transition];
}

class TransitionList extends SvelteComponent {
  constructor(options) {
    super();
    init(
      this,
