...
compileFile('src/index.svelte', 'app').then(() => {
  compileFile('src/transitionList.svelte', 'transitionList').then(() => {
    compileFile('src/libTransitions.svelte', 'libTransitions').then(() => {
